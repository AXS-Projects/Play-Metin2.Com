...
<div class="glassmorphism p-6 rounded-lg shadow-lg border border-gray-700">
    <h2 class="text-xl font-semibold mb-4 text-green-400">My Tickets</h2>
    <a href="{{ route('tickets.create') }}" class="mb-4 inline-block px-4 py-2 bg-green-600 text-white rounded">New Ticket</a>
    <ul class="space-y-4">
